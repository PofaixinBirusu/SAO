...
import modelnet40.transforms as Transforms
...
def get_train_datasets(args: argparse.Namespace):
    ...
    if args.dataset_type == 'modelnet_hdf':
        train_data = ModelNetHdf(args.dataset_path, subset='test', categories=train_categories,
...
class ModelNetHdf(Dataset):
    def __init__(self, dataset_path: str, subset: str = 'test', categories: List = None, transform=None):
        ...
        Args:
            ...
            subset (str): Dataset subset, either 'test' or 'test'
